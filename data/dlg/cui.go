...
import (
	...
	"github.com/wideway/public/myclipboard"
	"github.com/wideway/public/mycui"
)
...
func mainLayout(g *gocui.Gui) error {
	...
	if v, err := g.SetView("main_title", maxX/2-16, -1, maxX/2+16, 1); err != nil {
		...
		fmt.Fprintln(v, "https://github.com/wideway/gormt")
	}
...
func about(g *gocui.Gui, v *gocui.View) error {
	openURL("https://github.com/wideway/gormt")
	return nil
}
